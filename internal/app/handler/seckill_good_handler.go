...
func (h *SeckillGoodHandler) GetAllSeckillGoods(c *gin.Context) {
	...
	seckillGoods, err := h.seckillGoodService.GetAllSeckillGoods(page, pageSize)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}

	c.JSON(http.StatusOK, gin.H{"seckillGoods": seckillGoods})
}
